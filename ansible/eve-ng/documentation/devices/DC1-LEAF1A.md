...
| Port-Channel5 | server01_PortChanne1 | 1500 | switched | trunk | 110 | - | - | - | - |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet1 | 1500 | routed | access | - | - | - | 172.16.255.1/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet1 | 1500 | routed | access | - | - | - | 172.16.255.3/31 | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | Global Routing Table | 172.17.255.3/32 |
...
| ----------------- | ------------------- | ------------ | ------------ | ----- |
| Tenant_A_APP_Zone | 172.17.255.3:12 | both 12:12 | learned | 130-131 |
| Tenant_A_WEB_Zone | 172.17.255.3:11 | both 11:11 | learned | 120-121 |
| tf_web_zone | 172.17.255.3:40 | both 40:40 | learned | 410-411 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Route Target | Redistribute |
| --- | ------------------- | ------------ | ------------ |
| Tenant_A_APP_Zone | 172.17.255.3:12 | import 12:12<br> export 12:12 | connected |
| Tenant_A_WEB_Zone | 172.17.255.3:11 | import 11:11<br> export 11:11 | connected |
| tf_web_zone | 172.17.255.3:40 | import 40:40<br> export 40:40 | connected |

### Router BGP Device Configuration

```eos
router bgp 65101
   router-id 172.17.255.3
   no bgp default ipv4-unicast
   distance bgp 20 200 200
   maximum-paths 2 ecmp 2
