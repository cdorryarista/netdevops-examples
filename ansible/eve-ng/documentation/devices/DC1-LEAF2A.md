...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet3 | 1500 | routed | access | - | - | - | 172.16.255.9/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet3 | 1500 | routed | access | - | - | - | 172.16.255.11/31 | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | Global Routing Table | 172.17.255.5/32 |
...
| ----------------- | ------------------- | ------------ | ------------ | ----- |
| Tenant_A_APP_Zone | 172.17.255.5:12 | both 12:12 | learned | 130-131 |
| Tenant_A_DB_Zone | 172.17.255.5:13 | both 13:13 | learned | 140-141 |
| Tenant_A_NFS | 172.17.255.5:10161 | both 10161:10161 | learned | 161 |
| Tenant_A_OP_Zone | 172.17.255.5:10 | both 10:10 | learned | 110-112 |
| Tenant_A_VMOTION | 172.17.255.5:50160 | both 50160:50160 | learned | 160 |
| Tenant_A_WEB_Zone | 172.17.255.5:11 | both 11:11 | learned | 120-121 |
| Tenant_B_OP_Zone | 172.17.255.5:20 | both 20:20 | learned | 210-211 |
| Tenant_C_OP_Zone | 172.17.255.5:30 | both 30:30 | learned | 310-311 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Route Target | Redistribute |
| --- | ------------------- | ------------ | ------------ |
| Tenant_A_APP_Zone | 172.17.255.5:12 | import 12:12<br> export 12:12 | connected |
| Tenant_A_DB_Zone | 172.17.255.5:13 | import 13:13<br> export 13:13 | connected |
| Tenant_A_OP_Zone | 172.17.255.5:10 | import 10:10<br> export 10:10 | connected |
| Tenant_A_WEB_Zone | 172.17.255.5:11 | import 11:11<br> export 11:11 | connected |
| Tenant_B_OP_Zone | 172.17.255.5:20 | import 20:20<br> export 20:20 | connected |
| Tenant_C_OP_Zone | 172.17.255.5:30 | import 30:30<br> export 30:30 | connected |

### Router BGP Device Configuration

```eos
router bgp 65102
   router-id 172.17.255.5
   no bgp default ipv4-unicast
   distance bgp 20 200 200
   maximum-paths 2 ecmp 2
   ...
   neighbor 172.16.255.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.255.10 peer group IPv4-UNDERLAY-PEERS
