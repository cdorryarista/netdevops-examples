...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-LEAF1A_Ethernet1 | 1500 | routed | access | - | - | - | 192.16.255.0/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-LEAF1B_Ethernet1 | 1500 | routed | access | - | - | - | 192.16.255.4/31 | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-LEAF2A_Ethernet1 | 1500 | routed | access | - | - | - | 192.16.255.8/31 | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-LEAF2B_Ethernet1 | 1500 | routed | access | - | - | - | 192.16.255.12/31 | - | - |
| Ethernet5 | P2P_LINK_TO_DC1-LEAF3A_Ethernet1 | 1500 | routed | access | - | - | - | 192.16.255.16/31 | - | - |
| Ethernet6 | P2P_LINK_TO_DC1-LEAF3B_Ethernet1 | 1500 | routed | access | - | - | - | 192.16.255.20/31 | - | - |
...
interface Ethernet1
   ...
   no switchport
   ip address 192.16.255.0/31
!
interface Ethernet2
   description P2P_LINK_TO_DC1-LEAF1B_Ethernet1
   no switchport
   ip address 192.16.255.4/31
!
interface Ethernet3
   description P2P_LINK_TO_DC1-LEAF2A_Ethernet1
   no switchport
   ip address 192.16.255.8/31
!
interface Ethernet4
   description P2P_LINK_TO_DC1-LEAF2B_Ethernet1
   no switchport
   ip address 192.16.255.12/31
!
interface Ethernet5
   description P2P_LINK_TO_DC1-LEAF3A_Ethernet1
   no switchport
   ip address 192.16.255.16/31
!
interface Ethernet6
   description P2P_LINK_TO_DC1-LEAF3B_Ethernet1
   no switchport
   ip address 192.16.255.20/31
!
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | Global Routing Table | 192.17.255.1/32 |
...
router bgp 65001
   ...
   neighbor 192.16.255.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.16.255.1 remote-as 65101
   neighbor 192.16.255.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.16.255.5 remote-as 65101
   neighbor 192.16.255.9 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.16.255.9 remote-as 65102
   neighbor 192.16.255.13 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.16.255.13 remote-as 65102
   neighbor 192.16.255.17 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.16.255.17 remote-as 65103
   neighbor 192.16.255.21 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.16.255.21 remote-as 65103
