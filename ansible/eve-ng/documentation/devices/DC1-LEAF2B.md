...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.100.6/24 | 192.168.100.252 |
...
| Port-Channel5 | server02_PortChanne1 | 1500 | switched | trunk | 210-211 | - | 5 | - | - |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet4 | 1500 | routed | access | - | - | - | 192.16.255.13/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet4 | 1500 | routed | access | - | - | - | 192.16.255.15/31 | - | - |
...
| Ethernet5 | server02_Eth3 | *1500 | *switched | *trunk | *210-211 | - | - | - | 5 | active |
...
interface Ethernet1
   ...
   no switchport
   ip address 192.16.255.13/31
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SPINE2_Ethernet4
   no switchport
   ip address 192.16.255.15/31
!
interface Ethernet3
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | Global Routing Table | 192.17.255.6/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | Global Routing Table | 192.17.254.5/32 |
...
interface Loopback0
   ...
   ip address 192.17.255.6/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   ip address 192.17.254.5/32
!
...
mlag configuration
   ...
   peer-address heartbeat 192.168.100.5 vrf MGMT
...
| ----------------- | ------------------- | ------------ | ------------ | ----- |
| Tenant_A_APP_Zone | 192.17.255.6:12 | both 12:12 | learned | 130-131 |
| Tenant_A_DB_Zone | 192.17.255.6:13 | both 13:13 | learned | 140-141 |
| Tenant_A_NFS | 192.17.255.6:10161 | both 10161:10161 | learned | 161 |
| Tenant_A_OP_Zone | 192.17.255.6:10 | both 10:10 | learned | 110-112 |
| Tenant_A_VMOTION | 192.17.255.6:50160 | both 50160:50160 | learned | 160 |
| Tenant_A_WEB_Zone | 192.17.255.6:11 | both 11:11 | learned | 120-121 |
| Tenant_B_OP_Zone | 192.17.255.6:20 | both 20:20 | learned | 210-211 |
| Tenant_C_OP_Zone | 192.17.255.6:30 | both 30:30 | learned | 310-311 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Route Target | Redistribute |
| --- | ------------------- | ------------ | ------------ |
| Tenant_A_APP_Zone | 192.17.255.6:12 | import 12:12<br> export 12:12 | connected |
| Tenant_A_DB_Zone | 192.17.255.6:13 | import 13:13<br> export 13:13 | connected |
| Tenant_A_OP_Zone | 192.17.255.6:10 | import 10:10<br> export 10:10 | connected |
| Tenant_A_WEB_Zone | 192.17.255.6:11 | import 11:11<br> export 11:11 | connected |
| Tenant_B_OP_Zone | 192.17.255.6:20 | import 20:20<br> export 20:20 | connected |
| Tenant_C_OP_Zone | 192.17.255.6:30 | import 30:30<br> export 30:30 | connected |

### Router BGP Device Configuration

```eos
router bgp 65102
   router-id 192.17.255.6
   no bgp default ipv4-unicast
   distance bgp 20 200 200
   maximum-paths 2 ecmp 2
   ...
   neighbor 192.16.255.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.16.255.14 peer group IPv4-UNDERLAY-PEERS
